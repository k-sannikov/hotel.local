...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'date_of_arrival'       => 'Дата заселения',
        ...
        'hotel_name'            => 'Отель',
        'date_of_arrival'       => 'Дата заселения',
        'date_of_departure'     => 'Дата выселения',
        'room_type'             => 'Тип номера',
        'room_cost'             => 'Стоимость номера',
        'amenities'             => 'Дополнительные услуги',
        'percent_discounts'     => 'Скидка в процентах',
        'amount_discounts'      => 'Сумма скидки',
        'total_cost'            => 'Итоговая стоимость',
        'admin_name'            => 'Имя администартора',
